                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                <div class="card-header border-0 pb-0">
                                    <div class="card-title text-center">
                                        <img src="app-assets/images/logo/logo-dark.png" alt="branding logo" style="width: 50%;">
                                    </div>
                                ...
                                <div class="card-content">
                                        ...
                                        <form class="form-horizontal" action="{{ route('user.save') }}" method="post">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                {{-- <div class="row"> --}}
                                                    {{-- First Name --}}
                                                    {{-- <div class="col-md-6"> --}}
                                                        <input type="text" class="form-control" name="name" id="user-name" placeholder="User Name" autofocus required>
                                                    ...
                                                    {{-- Last Name --}}
                                                    {{-- <div class="col-md-6">
                                                        <input type="text" class="form-control" name="last_name" id="user-name" placeholder="Last Name" autofocus required>
                                                        <div class="form-control-position">
                                                            <i class="la la-user"></i>
                                                        </div>
                                                    </div> --}}
                                            ...
                                            {{-- Phone Number --}}
                                            {{-- <fieldset class="form-group position-relative has-icon-left">
                                                <input type="tel" class="form-control" name="phone" id="user-mobile" placeholder="Enter Mobile Number" required>
                                                <div class="form-control-position">
                                    ...
                                    <p class="card-subtitle line-on-side text-muted text-center font-small-3 mx-2 my-1"><span>Already Registered!</span></p>
                                    <div class="card-body">
