    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">ALL Particulars</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">ALL Particulars
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="media width-250 float-right">
                    ...
                    <div class="media-body media-right text-right">
                        <a class="btn btn-sm btn-primary box-shadow-2 round btn-min-width pull-right white"
                            href="{{ route('particulars.create') }}">
                            <i class="ft-plus white"></i>Add Particular
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <h4 class="card-title float-left">Particulars</h4>
                                    ...
                                    <div class="card-body mt-1">
                                        <div class="table-responsive">
                                            <table id="address" class="table display alt-pagination table-wrapper">
                                                ...
                                                <tbody>
                                                    @foreach ($particulars as $address)
                                                    <tr>
                                                        <td>{{ $address->id }}</td>
                                                        <td>{{ $address->ammount }}</td>
                                                        <td>{{ $address->description }}</td>
                                                        <td>
                                                            <form action="{{ route('particulars.destroy', $address->id) }}" method="POST">
                                                                <a href="{{ route('particulars.edit', $address->id) }}">
